...
router.route("/c/:username").get(verifyJWT, getUserChannelProfile); // params use ho raha hai

router.route("/history").get(verifyJWT, getWatchHistory); // user kuch bhej nahi raha hai to get ka use kiya
